...
function scene:create( event )
    ...
    print ("level4 scene:create did")
lm.currentLevel = 4 -- sa retry vet hvilken bane den skal restarte
...
function scene:show( event )
    ...
    if ( phase == "will" ) then
        print ("level4 scene:show will")
    elseif ( phase == "did" ) then
        print ("level4 scene:show did")
        --last:pause()
...
function scene:hide( event )
    ...
    if ( phase == "will" ) then
       ...
       print ("level4 scene:hide will")
   elseif ( phase == "did" ) then
       print ("level4 scene:hide did")
...
function scene:destroy( event )
    ...
    local sceneGroup = self.view
        print ("level4 scene:destroy did")
