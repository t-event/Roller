...
local physicsData = (require "lib.shapedefs3").physicsData(scaleFactor)
...
function scene:create( event )
    ...
    print ("level3 scene:create did")
lm.currentLevel = 3 -- sa retry vet hvilken bane den skal restarte
...
local weldJoint9 = physics.newJoint( "weld", knott9, del9, knott9.x, knott9.x )
                                      ...
                                      local     firkant1 = display.newImageRect("level3/1.png", 7680,4702)
                                                firkant1.x = 3500
                                                firkant1.y = 2300
                                      ...
                                      local     firkant2 = display.newImageRect("level3/2.png", 7680,4702)
                                      ...
                                      local     firkant3 = display.newImageRect("level3/3.png", 7680,4702)
                                      ...
                                      local     firkant4 = display.newImageRect("level3/4.png", 7680,4702)
...
function scene:show( event )
    ...
    if ( phase == "will" ) then
        print ("level3 scene:show will")
    elseif ( phase == "did" ) then
        print ("level3 scene:show did")
        --last:pause()
...
function scene:hide( event )
    ...
    if ( phase == "will" ) then
       ...
       print ("level3 scene:hide will")
   elseif ( phase == "did" ) then
       print ("level3 scene:hide did")
...
function scene:destroy( event )
    ...
    local sceneGroup = self.view
        print ("level3 scene:destroy did")
