...
lm.currentLevel = 2 -- s̴ retry vet hvilken bane den skal restarte
...
local weldJoint9 = physics.newJoint( "weld", knott9, del9, knott9.x, knott9.x )
                                      ...
                                      local     firkant2 = display.newImageRect("level2/2.png", 7680,4702)
                                      ...
                                      local     firkant3 = display.newImageRect("level2/3.png", 7680,4702)
                                      ...
                                      local     firkant4 = display.newImageRect("level2/4.png", 7680,4702)
