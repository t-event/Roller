...
function scene:create( event )
	...
	local score = display.newText( sceneGroup, "Score:", slider.x-slider.width/2-60, slider.y, "Helvetica", 40 )
	scoreText = display.newText( sceneGroup, "0", slider.x+slider.width/2+40, slider.y, "Helvetica", 40 )
